...
if joinedRaidId then
    ...
    -- The new 30-second delay you requested
    print("Waiting 30 seconds before starting the main routine...")
    wait(30)
    
	print("Starting the raid routine...")
	local startTime = tick()
	
	-- Run the routine for 30 minutes (1800 seconds)
	while tick() - startTime < 1800 do
